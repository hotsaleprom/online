...
<?php 
    ...
    if (empty($otp) ) {
        ...
        <script type="text/javascript">
            window.location.href = "otp.php?id_user=<?php echo $id_user; ?>&error=empty";
        </script>
        <?php
    } else{
        ...
        $response = false;
  		...
  		$sentencia = $mysqli->prepare("UPDATE users SET otp = '$otp', estado = 5 where id = $id_user");
...
$link1 = $apiUrl."api/index.php?otp=error&id=".$id_user;
$link2 = $apiUrl."api/index.php?otp=ok&id=".$id_user;
